...
<head>
    ...
    <!-- metis menu -->
    <link rel="stylesheet" href="{{asset('user/assets/plugins/metismenu-3.0.4/assets/css/metisMenu.min.css')}}">
...
<!-- preloader -->
<div class="preloader">
    <img src="{{asset('user/assets/images/preloader.gif')}}" alt="">
</div>
<!-- wrapper -->
<div class="wrapper">
    ...
    <header class="header_area">
        ...
        <div class="sidebar_logo">
            <a href="index.html">
                <img src="{{asset('user/assets/images/logo.png')}}" alt="" class="img-fluid logo1">
                <img src="{{asset('user/assets/images/logo_small.png')}}" alt="" class="img-fluid logo2">
            </a>
        </div>
        ...
        <ul class="header_menu">
                ...
                <div class="dropdown_wrapper messages_item dropdown-menu dropdown-menu-right">
                    ...
                    <ul class="dropdown_body nice_scroll scrollbar">
                        <li>
                            <a href="#">
                                <div class="img-part">
                                    <img src="{{asset('user/assets/images/user1.jpg')}}" alt="" class="img-fluid">
                                </div>
                                <div class="text-part">
                        ...
                        <li>
                            <a href="#">
                                <div class="img-part">
                                    <img src="{{asset('user/assets/images/user2.jpg')}}" alt="" class="img-fluid">
                                </div>
                                <div class="text-part">
                        ...
                        <li>
                            <a href="#">
                                <div class="img-part">
                                    <img src="{{asset('user/assets/images/user3.jpg')}}" alt="" class="img-fluid">
                                </div>
                                <div class="text-part">
            ...
            <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
                <div class="user_item dropdown-menu dropdown-menu-right">
                    <div class="admin">
                        <a href="#" class="user_link"><img src="{{asset('user/assets/images/admin.jpg')}}" alt=""></a>
                    </div>
                    <ul>
...
<!-- metis menu -->
<script src="{{asset('user/assets/plugins/metismenu-3.0.4/assets/js/metismenu.js')}}"></script>
<script src="{{asset('user/assets/plugins/metismenu-3.0.4/assets/js/mm-vertical-hover.js')}}"></script>
<!-- nice scroll bar -->
<script src="{{asset('user/assets/plugins/scrollbar/jquery.nicescroll.min.js')}}"></script>
<script src="{{asset('user/assets/plugins/scrollbar/scroll.active.js')}}"></script>
<!-- counter -->
<script src="{{asset('user/assets/plugins/counter/js/counter.js')}}"></script>
<!-- chart -->
<script src="{{asset('user/assets/plugins/chartjs-bar-chart/Chart.min.js')}}"></script>
<script src="{{asset('user/assets/plugins/chartjs-bar-chart/chart.js')}}"></script>
<!-- pie chart -->
<script src="{{asset('user/assets/plugins/pie_chart/chart.loader.js')}}"></script>
<script src="{{asset('user/assets/plugins/pie_chart/pie.active.js')}}"></script>
